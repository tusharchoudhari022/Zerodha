...
public class SignUp {
	...
	SignUp(WebDriver kaypan) {                   // parameterized constructor
	...
	public void selectbday(int day) {     //if parameter is int then select by index
		Select s = new Select(bday);
		s.selectByIndex(day);
	}

	public void selectmonth(int bdmnth) {
		Select s1 = new Select(month);
		s1.selectByIndex(bdmnth);
	}

	public void selectyear(String yr) {       //if parameter is string then select by VisibleText or Value
